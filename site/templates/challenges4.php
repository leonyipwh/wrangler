                ...
                <div class="bigC4_click">   
                  <ul class="orbit-content" data-orbit>
                    <li data-orbit-slide="1">
                      <a data-orbit-link="2">
                        <img src="../assets/img/bigC4_hk.jpg"/>  
                      </a>
                    </li>
    ...
    <div id="lowerContainer">
      ...
      <div class="row">
        <div class="large-12 columns">
          ...
          <div class="large-6 columns">
            <h2 id="rewardTitle">Win a winter jacket</h2>
            <br>
            <div id="rewardContent">
              <p><img id="icons" src="../assets/img/icons.png"></p>
              <p>Sometimes even the sun can’t keep you from the bite of cold. This week’s ultimate sun chaser will take home this AW14 winter jacket. Stay toasty on every adventure&#33;</p>
